...
\author{Adrin Jalali}
% \\ \small{Supervised by: Nico Pfeifer}}
...
\begin{frame}[plain]{}
  ...
  \end{textblock*}
  \begin{textblock*}{\paperwidth}(0.8\textwidth,0.12\textheight)
    \raggedright
  ...
  \begin{columns}[T]
        ...
        \begin{columns}
          ...
          \begin{column}{0.5\textwidth}
            \begin{figure}
              ...
              \caption{\tiny Yeast protein interaction network. The colour of a node indicates the phenotypic effect of removing the corresponding protein ({\color{red}red} = lethal, {\color{green}green} = non-lethal, {\color{orange}orange} = slow growth, {\color{yellow}yellow} = unknown), A. BarabÃ¡si, Z. Oltvai, Nature Reviews Genetics, (2004)}
            \end{figure}
    ...
    \begin{column}{0.3\textwidth}
      ...
      \begin{enumerate}
        \footnotesize
        \item SVM modified objective function
          \tiny
          \begin{center}
            \begin{align*}
  ...
  \mytitle{Results}
    \begin{columns}
      ...
      \begin{column}{0.25\textwidth}
        ...
        \end{tabular}
        \caption{\footnotesize Performance summary of three cases}
        \end{figure}
      \end{column}
    \end{columns}
    ...
    \begin{columns}[T]
        ...
        \begin{columns}
          \begin{column}{0.3\textwidth}
            ...
            \item For each sample in class A and B:
              \begin{itemize}
                \scriptsize
              \item Weight genes according to their distance from means of estimated distributions.
              \item Extract higher weighted parts of generated network.
              \end{itemize}
          ...
          \begin{column}{0.3\textwidth}
            \begin{figure}
              \includegraphics[width=0.7\textwidth]{weighted-1}\\
              \includegraphics[width=0.7\textwidth]{weighted-2}
              \caption{\footnotesize Sample graphs of two classes}
            \end{figure}
          \end{column}
        \end{columns}
      \end{column}
      \begin{column}{0.2\textwidth}
        ...
        \tiny
        Acknowledgment:\\
        Prof. Dr. Dr. Thomas Lengauer, Dr. Nico Pfeifer, Sarvesh Nimkubh, Nora Speicher, Anna Feldmann.\\
        References:\\
        ...
        2. Lavi, Ofer, Gideon Dror, and Ron Shamir. "Network-induced classification kernels for gene expression profile analysis." Journal of Computational Biology 19.6 (2012): 694-709.\\
        3. Barabási, Albert-László, and Zoltan N. Oltvai. "Network biology: understanding the cell's functional organization." Nature Reviews Genetics 5.2 (2004): 101-113.
      \end{column}
    \end{columns}
  \end{frame}
\end{document}
